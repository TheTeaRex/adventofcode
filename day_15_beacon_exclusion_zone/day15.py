...
class Solution:
    def __init__(self, filename: str):
        ...
        ):  # added this if statement for pytesting the example_input
            self.part1 = self.solution_part_1(cave, 10)
            self.part2 = self.solution_part_2(cave, 20)
        else:
            self.part1 = self.solution_part_1(cave, 2000000)
            self.part2 = self.solution_part_2(cave, 4000000)
    ...
    def remove_overlapped_ranges(self, ranges: List[List[int]]):
    ...
    def solution_part_1(self, cave: Cave, row: int) -> int:  # noqa: C901
        ...
        ranges = self.remove_overlapped_ranges(ranges)
        for item in ranges:
